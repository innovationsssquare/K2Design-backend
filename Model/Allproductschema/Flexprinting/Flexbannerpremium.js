...
const flexBannerPrintpremiumSchema = new mongoose.Schema(
  {
    name: {
      type: String,
      required: true,
...
flexBannerPrintpremiumSchema.pre("save", function (next) {
...
module.exports = mongoose.model(
  "FlexBannerPrintpremium",
  flexBannerPrintpremiumSchema
);
