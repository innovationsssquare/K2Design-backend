...
} = require("../../../Controller/Allproductcontroller/Flexprinting/Flexbannerpremium");

const FlexBannerprePrintRouter = express.Router();
...
FlexBannerprePrintRouter.get("/get/FlexBannerPrints", GetAllFlexBannerPrints);

// Route to get a single Flex Banner Print by ID
FlexBannerprePrintRouter.get(
...
FlexBannerprePrintRouter.delete(
...
module.exports = { FlexBannerprePrintRouter };
