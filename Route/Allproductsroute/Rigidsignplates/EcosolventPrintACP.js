...
} = require("../../../Controller/Allproductcontroller/Rigidsignplates/EcosolventPrintACP");

const AcpPlateRouter = express.Router();
...
AcpPlateRouter.get("/get/AcpPlate", GetAllAcpPlates);
